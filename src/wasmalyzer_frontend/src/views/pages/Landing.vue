    ...
    <header class="relative z-50 w-full h-24">
        <div
            ...
            <a href="/" class="relative flex items-center inline-block h-5 h-full font-black leading-none">
                <svg class="w-auto h-6 text-emerald-500 fill-current" viewBox="0 0 194 116"
                ...
                <span class="ml-3 text-xl text-gray-800">CipherMind<span class="text-pink-500">.</span></span>
            </a>

            <nav id="nav"
                class="absolute top-0 left-0 z-50 flex flex-col items-center justify-between hidden w-full h-64 pt-5 mt-24 text-sm text-gray-800 bg-white border-t border-gray-200 md:w-auto md:flex-row md:h-24 lg:text-base md:bg-transparent md:mt-0 md:border-none md:py-0 md:flex md:relative">
                <a href="#"
                    class="ml-0 mr-0 font-bold duration-100 md:ml-12 md:mr-3 lg:mr-8 transition-color hover:text-emerald-500">Home</a>
                <a href="#features"
                    class="mr-0 font-bold duration-100 md:mr-3 lg:mr-8 transition-color hover:text-emerald-500">Features</a>
                <a href="#pricing"
                    class="mr-0 font-bold duration-100 md:mr-3 lg:mr-8 transition-color hover:text-emerald-500">Pricing</a>
                <a href="#testimonials"
                    class="font-bold duration-100 transition-color hover:text-emerald-500">Testimonials</a>
                <div class="flex flex-col block w-full font-medium border-t border-gray-200 md:hidden">
                    <a href="/auth/login" class="w-full py-2 font-bold text-center text-pink-500">Login</a>
                    <a href="#_"
                        class="relative inline-block w-full px-5 py-3 text-sm leading-none text-center text-white bg-emerald-500 fold-bold">Get
                        Started</a>
                </div>
            </nav>
            ...
            <div
                ...
                <a href="#_"
                    class="relative z-40 inline-block w-auto h-full px-5 py-3 text-sm font-bold leading-none text-white transition-all transition duration-100 duration-300 bg-emerald-700 rounded shadow-md fold-bold lg:bg-white lg:text-indigo-700 sm:w-full lg:shadow-none hover:shadow-xl">Get
                    Started</a>
    ...
    <div class="relative items-center justify-center w-full overflow-x-hidden lg:pt-40 lg:pb-40 xl:pt-40 xl:pb-64">
        <div
            ...
            <div
                ...
                <h1 class="relative mb-4 text-3xl font-black leading-tight text-gray-900 sm:text-6xl xl:mb-8">Scan, Secure, and Deploy </h1>
                <p class="pr-0 mb-8 text-base text-gray-600 sm:text-lg xl:text-xl lg:pr-20">Are you ready to start your
                    blockchain journey on the SAFE side?</p>
                    <p class="pr-0 mb-8 text-base text-gray-600 sm:text-lg xl:text-xl lg:pr-20">Deploy on ICP – AI-Powered Vulnerability Detection & Defense!</p>
                <a href="#_"
                    class="relative self-start inline-block w-auto px-8 py-4 mx-auto mt-0 text-base font-bold text-white bg-emerald-500 border-t border-gray-200 rounded-md shadow-xl sm:mt-1 fold-bold lg:mx-0">Signup
                    Today!</a>
            ...
            <div class="relative z-50 flex flex-col items-end justify-center w-full h-full lg:w-1/2 ms:pl-10">
                <div class="container relative left-0 w-full max-w-4xl lg:absolute xl:max-w-6xl lg:w-screen">
                    <img src="/demo/images/landing/Ai2.webp"
...
<div id="features" class="relative w-full px-8 py-10 border-t border-gray-200 md:py-16 lg:py-24 xl:py-40 xl:px-0">
    <div class="container flex flex-col items-center justify-between h-full max-w-6xl mx-auto">
        <h2 class="my-5 text-base font-medium tracking-tight text-emerald-500 uppercase text-center">Our Features</h2>
        <h3
        ...
        <div class="flex flex-col w-full mt-0 lg:flex-row sm:mt-10 lg:mt-20">
            ...
            <div class="w-full max-w-md p-4 mx-auto mb-0 sm:mb-16 lg:mb-0 lg:w-1/3">
                <div class="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
                    ...
                    <h4 class="relative mt-6 text-lg font-bold text-center">AI-Powered Vulnerability Detection</h4>
                    <p class="relative mt-2 text-base text-center text-gray-600">Advanced AI algorithms scan your code for vulnerabilities, identifying potential threats before deployment.</p>
                    <a href="#_" class="relative flex mt-2 text-sm font-medium text-emerald-500 underline mx-auto">Learn
                        More</a>
                </div>
            </div>
            ...
            <div class="w-full max-w-md p-4 mx-auto mb-0 sm:mb-16 lg:mb-0 lg:w-1/3">
                <div class="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
                    ...
                    <h4 class="relative mt-6 text-lg font-bold text-center">ICP Canister Optimization</h4>
                    <p class="relative mt-2 text-base text-center text-gray-600">Specialized tools to optimize your canisters for the Internet Computer, reducing cycle consumption and enhancing performance.</p>
                    <a href="#_" class="relative flex mt-2 text-sm font-medium text-emerald-500 underline mx-auto">Learn
                        More</a>
                </div>
            </div>
            ...
            <div class="w-full max-w-md p-4 mx-auto mb-16 lg:mb-0 lg:w-1/3">
                <div class="relative flex flex-col items-center justify-center w-full h-full p-20 mr-5 rounded-lg">
                    ...
                    <h4 class="relative mt-6 text-lg font-bold text-center">Automatic Code Remediation</h4>
                    <p class="relative mt-2 text-base text-center text-gray-600">AI-powered suggestions to automatically fix identified vulnerabilities in your Motoko or Rust canisters.</p>
                    <a href="#_" class="relative flex mt-2 text-sm font-medium text-emerald-500 underline mx-auto">Learn
                        More</a>
                </div>
            </div>
...
<!-- END FEATURES SECTION -->
    ...
    <div class="relative px-8 py-10 bg-white border-t border-gray-200 md:py-16 lg:py-24 xl:py-40 xl:px-0">
        ...
        <div id="pricing" class="container flex flex-col items-center h-full max-w-6xl mx-auto">
            <h2 class="my-5 text-base font-medium tracking-tight text-emerald-500 uppercase">Our Pricing</h2>
            <h3
            ...
            <div class="max-w-full mx-auto md:max-w-6xl sm:px-8">
                ...
                <div class="relative flex flex-col items-center block sm:flex-row">
                    ...
                    <div
                        ...
                        <div
                            class="py-4 text-sm font-semibold leading-none tracking-wide text-center text-white uppercase bg-emerald-500 rounded-t">
                            Most Popular</div>
                        ...
                        <div class="flex items-center block p-8 uppercase">
                            <a href="#_"
                                class="block w-full px-6 py-4 mt-3 text-lg font-semibold text-center text-white bg-gray-900 rounded shadow-sm hover:bg-emerald-500">Select
                                This Plan</a>
                        </div>
                    </div>
                    <!-- Premium Pricing -->
        ...
        <div class="max-w-6xl mx-auto">
            <div class="flex-col items-center ">
                <div class="flex flex-col items-center justify-center w-full h-full max-w-2xl pr-8 mx-auto text-center">
                    <p class="my-5 text-base font-medium tracking-tight text-emerald-500 uppercase">Our customers love
                        our product
                    </p>
                    <h2
                        ...
                        <blockquote
                            ...
                            <div class="flex flex-col pr-8">
                                <div class="relative pl-12">
                                    <svg class="absolute left-0 w-10 h-10 text-emerald-500 fill-current"
    ...
    <!-- filepath: /var/www/html/project/icp/ai_agent/src/wasmalyzer_frontend/src/views/pages/Landing.vue -->
<footer class="px-4 pt-12 pb-8 text-white bg-white border-t border-gray-200">
    <div class="container flex flex-col justify-between max-w-6xl px-4 mx-auto overflow-hidden lg:flex-row">
        <div class="w-full pl-12 mr-4 text-left lg:w-1/4 sm:text-center sm:pl-0 lg:text-left">
            ...
            <p class="mt-6 mr-4 text-base text-gray-500">Securing the Internet Computer ecosystem with AI-powered protection for your canisters and dApps.
            </p>
        </div>
        <div class="block w-full pl-10 mt-6 text-sm lg:w-3/4 sm:flex lg:mt-0">
            <ul class="flex flex-col w-full p-0 font-medium text-left text-gray-700 list-none">
                <li class="inline-block px-3 py-2 mt-5 font-bold tracking-wide text-gray-800 uppercase md:mt-0">
                    Solutions</li>
                <li><a href="#features"
                        class="inline-block px-3 py-2 text-gray-500 no-underline hover:text-gray-600">Vulnerability Detection</a>
                </li>
                <li><a href="#_"
                        class="inline-block px-3 py-2 text-gray-500 no-underline hover:text-gray-600">Canister Optimization</a>
                </li>
                <li><a href="#_"
                        class="inline-block px-3 py-2 text-gray-500 no-underline hover:text-gray-600">Secure Deployment</a>
                </li>
                <li><a href="#_"
                        class="inline-block px-3 py-2 text-gray-500 no-underline hover:text-gray-600">Code Remediation</a></li>
            </ul>
            <ul class="flex flex-col w-full p-0 font-medium text-left text-gray-700 list-none">
                <li class="inline-block px-3 py-2 mt-5 font-bold tracking-wide text-gray-800 uppercase md:mt-0">
                    Resources</li>
                <li><a href="#_"
                        class="inline-block px-3 py-2 text-gray-500 no-underline hover:text-gray-600">ICP Security Guide</a>
                </li>
                <li><a href="#_" class="inline-block px-3 py-2 text-gray-500 no-underline hover:text-gray-600">Motoko Best Practices</a></li>
                <li><a href="#_" class="inline-block px-3 py-2 text-gray-500 no-underline hover:text-gray-600">Rust Canister Security</a></li>
                <li><a href="#_" class="inline-block px-3 py-2 text-gray-500 no-underline hover:text-gray-600">Blockchain Security Blog</a></li>
            </ul>
            <ul class="flex flex-col w-full p-0 font-medium text-left text-gray-700 list-none">
                <li class="inline-block px-3 py-2 mt-5 font-bold tracking-wide text-gray-800 uppercase md:mt-0">
                    Ecosystem
                </li>
                <li><a href="https://internetcomputer.org/"
                        class="inline-block px-3 py-2 text-gray-500 no-underline hover:text-gray-600" target="_blank" rel="noopener noreferrer">Internet Computer</a></li>
                <li><a href="https://dfinity.org/"
                        class="inline-block px-3 py-2 text-gray-500 no-underline hover:text-gray-600" target="_blank" rel="noopener noreferrer">DFINITY Foundation</a></li>
                <li><a href="https://internetcomputer.org/docs/current/developer-docs/ic-overview"
                        class="inline-block px-3 py-2 text-gray-500 no-underline hover:text-gray-600" target="_blank" rel="noopener noreferrer">ICP Developer Docs</a></li>
            </ul>
            <div class="flex flex-col w-full text-gray-700">
                <div class="inline-block px-3 py-2 mt-5 font-bold text-gray-800 uppercase md:mt-0">Connect With Us</div>
                <div class="flex justify-start pl-4 mt-2">
                    <a class="flex items-center block mr-6 text-gray-400 no-underline hover:text-gray-600"
                        target="_blank" rel="noopener noreferrer" href="https://forum.dfinity.org/">
                    ...
                    <a class="flex items-center block mr-6 text-gray-400 no-underline hover:text-gray-600"
                        target="_blank" rel="noopener noreferrer" href="https://twitter.com/dfinity">
                        <svg viewBox="0 0 24 24" class="w-5 h-5 fill-current" xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <a class="flex items-center block text-gray-400 no-underline hover:text-gray-600"
                        target="_blank" rel="noopener noreferrer" href="https://github.com/dfinity">
                        <svg viewBox="0 0 24 24" class="w-5 h-5 fill-current" xmlns="http://www.w3.org/2000/svg">
                            <path
    ...
    <div class="pt-4 pt-6 mt-10 text-center text-gray-500 border-t border-gray-100">© 2025 Solanke. Securing the Internet Computer. Built with ♥ for the ICP ecosystem.</div>
</footer>
